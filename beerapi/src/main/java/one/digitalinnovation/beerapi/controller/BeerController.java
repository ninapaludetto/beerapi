...
public class BeerController implements BeerControllerDocs {
    ...
    @GetMapping
    public List<BeerDTO> list Beers() {return beerService.listAll();}
    ...
    public BeerDTO increment(@PathVariable Long id, @RequestBody @Valid QuantityDTO) throws BeerNotFoundException, BeerStockExceededException{
